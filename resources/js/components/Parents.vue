    ...
    <div class="wrapper">
        ...
        <!-- Content Wrapper. Contains page content -->
                <div class="content-wrapper">
                    ...
                    <Title titre="Espace Parent d'élève" description="Espace Parent d'élève"/>
                    <!-- /.content-header -->
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="container">
                                ...
                                <div class="form-group">
                                    <input type="text" v-model="keyword" class="form-control" placeholder="numero matricule de l'étudiant">
                                </div>
                                <div class="row mt-2" >
        ...
        methods:{
            getResults() {
                axios.get('api/livesearch', { params: { keyword: this.keyword } })
                    .then(res => this.etudiants = res.data)
                    .catch(error => {});
            },
            convert(jour){
